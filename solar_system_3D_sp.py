...
class Our_Solar_System(Entity):
    def __init__(self, **kwargs):
        ...
        self.exit_button = Button(text='Salir', scale_x=0.05, scale_y=0.025, position=(0.87, 0.485), color=color.red, text_size=0.9, text_color=color.black, eternal=True)
        self.hide_data = Button(text='Ocultar Datos', scale_x=0.13, scale_y=0.025, position=(0.77, 0.485), color=color.cyan, text_size=0.9, text_color=color.black, eternal=True)
        self.start_stop_button = Button(text='Iniciar', scale_x=0.07, scale_y=0.025, position=(0.19, 0.485), color=color.cyan, text_size=0.9, text_color=color.black, eternal=True)
        self.grid = Button(text='Cambiar Cuadrícula', scale_x=0.14, scale_y=0.025, position=(0.625, 0.485), color=color.cyan, text_size=0.9, text_color=color.black, eternal=True)
        self.repeat_button = Button(text='Repetir Apagado', scale_x=0.15, scale_y=0.025, position=(0.47, 0.485), color=color.cyan, text_size=0.9, text_color=color.black, eternal=True)
        self.units_menu=DropdownMenu('Seleccionar Unidades', buttons=[DropdownMenuButton(text='AU', on_click=Func(self.select_units, 'AU'),ignore_paused=True, eternal=True), 
                                        ...
                                        ignore_paused=True, scale=(0.15, 0.026), position=(0.233, 0.498), color=color.cyan, text_size=0.9, text_color=color.black, enabled = True, eternal=True)
        self.delay_lbl = Text(parent=self.parent, text="Retraso (Seg.)", x=0.09, y=0.49, scale=(1, 1), origin=(0, 0), color=color.cyan, text_size=0.8, eternal=True)
        ...
        self.increment_lbl = Text(parent=self.parent, text="Incremento (Horas)", x=-0.06, y=0.49, scale=(1, 1), origin=(0, 0), color=color.cyan, text_size=0.8, eternal=True)
        ...
        self.duration_lbl = Text(parent=self.parent, text="Duración (Años)", x=-0.234, y=0.49, scale=(1, 1), origin=(0, 0), color=color.cyan, text_size=0.8, eternal=True)
        ...
        self.duration_days_lbl = Text(parent=self.parent, text="Días =", x=-0.234, y=0.45, scale=(1, 1), origin=(0, 0), color=color.cyan, text_size=0.8, eternal=True)
        self.start_time_lbl = Text(parent=self.parent, text="Fecha / Hora de Inicio Local", x=-0.445, y=0.49, scale=(1, 1), origin=(0, 0), color=color.cyan, text_size=0.8, eternal=True)
        ...
        self.zone_lbl = Text(parent=self.parent, text="Zona horaria local", x=-0.73, y=0.49, scale=(1, 1), origin=(0, 0), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.latitude_lbl = Text(parent=self.parent, text="Latitud:", x=-0.79, y=0.44, scale=(1, 1), origin=(0.5, 0), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.longitude_lbl = Text(parent=self.parent, text="Longitud:", x=-0.79, y=0.417, scale=(1, 1), origin=(0.5, 0), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.altitude_lbl = Text(parent=self.parent, text="Altitud (m):", x=-0.79, y=0.394, scale=(1, 1), origin=(0.5, 0), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.time_now = Text(parent=self.parent, text="Hora local Ahora:", x=-0.88, y=0.371, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.time_end = Text(parent=self.parent, text="Hora Local Finalización:", x=-0.88, y=0.348, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.sun_rise_set = Text(parent=self.parent, text="Amanecer / Atardecer local:", x=-0.88, y=0.325, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.moon_rise_set = Text(parent=self.parent, text="Salida / Puesta de la Luna local:", x=-0.88, y=0.302, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.moon_new_full = Text(parent=self.parent, text="Próxima Luna Nueva / Luna Llena:", x=-0.88, y=0.279, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.moon_brightness = Text(parent=self.parent, text="Iluminación de la Luna:", x=-0.88, y=0.256, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.earth_moon = Text(parent=self.parent, text="Distancia de la Luna a la Tierra:", x=-0.88, y=0.233, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mercury_earth = Text(parent=self.parent, text="Distancia de Mercurio a la Tierra:", x=-0.88, y=0.21, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.venus_earth = Text(parent=self.parent, text="Distancia de Venus a la Tierra:", x=-0.88, y=0.187, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mars_earth = Text(parent=self.parent, text="Distancia de Marte a la Tierra:", x=-0.88, y=0.164, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.jupiter_earth = Text(parent=self.parent, text="Distancia de Júpiter a la Tierra:", x=-0.88, y=0.141, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.saturn_earth = Text(parent=self.parent, text="Distancia de Saturno a la Tierra:", x=-0.88, y=0.118, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.uranus_earth = Text(parent=self.parent, text="Distancia de Urano a la Tierra:", x=-0.88, y=0.095, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.neptune_earth = Text(parent=self.parent, text="Distancia de Neptuno a la Tierra:", x=-0.88, y=0.072, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mercury_sun = Text(parent=self.parent, text="Distancia de Mercurio al Sol:", x=-0.88, y=0.049, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.venus_sun = Text(parent=self.parent, text="Distancia de Venus al Sol:", x=-0.88, y=0.026, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.earth_sun = Text(parent=self.parent, text="Distancia de la Tierra al Sol:", x=-0.88, y=0.003, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mars_sun = Text(parent=self.parent, text="Distancia de Marte al Sol:", x=-0.88, y=-0.02, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.jupiter_sun = Text(parent=self.parent, text="Distancia de Júpiter al Sol:", x=-0.88, y=-0.043, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.saturn_sun = Text(parent=self.parent, text="Distancia de Saturno al Sol:", x=-0.88, y=-0.066, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.uranus_sun = Text(parent=self.parent, text="Distancia de Urano al Sol:", x=-0.88, y=-0.089, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.neptune_sun = Text(parent=self.parent, text="Distancia de Neptuno al Sol:", x=-0.88, y=-0.112, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.moon_orbits = Text(parent=self.parent, text="Luna Órbitas al Sol / Órbitas de la Tierra:", x=-0.88, y=-0.135, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mercury_days = Text(parent=self.parent, text="Rotaciones / Órbitas de Mercurio:", x=-0.88, y=-0.158, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.venus_days = Text(parent=self.parent, text="Rotaciones / Órbitas de Venus:", x=-0.88, y=-0.181, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.earth_days = Text(parent=self.parent, text="Rotaciones / Órbitas de la Tierra:", x=-0.88, y=-0.204, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mars_days = Text(parent=self.parent, text="Rotaciones / Órbitas de Marte:", x=-0.88, y=-0.227, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.jupiter_days = Text(parent=self.parent, text="Rotaciones / Órbitas de Júpiter:", x=-0.88, y=-0.250, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.saturn_days = Text(parent=self.parent, text="Rotaciones / Órbitas de Saturno:", x=-0.88, y=-0.273, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.uranus_days = Text(parent=self.parent, text="Rotaciones / Órbitas de Urano:", x=-0.88, y=-0.296, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.mercury_nearest = Text(parent=self.parent, text="Mercurio más Cercano a la Tierra:", x=-0.88, y=-0.365, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.venus_nearest = Text(parent=self.parent, text="Venus más Cercano a la Tierra:", x=-0.88, y=-0.388, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mars_nearest = Text(parent=self.parent, text="Marte más Cercano a la Tierra:", x=-0.88, y=-0.411, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.jupiter_nearest = Text(parent=self.parent, text="Júpiter más Cercano a la Tierra:", x=-0.88, y=-0.434, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.saturn_nearest = Text(parent=self.parent, text="Saturno más Cercano a la Tierra:", x=-0.88, y=-0.457, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.uranus_nearest = Text(parent=self.parent, text="Urano más Cercano a la Tierra:", x=-0.88, y=-0.480, scale=(1, 1), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.duration_days_lbl.text=(f'Días = {str(round(float(self.duration.text)*365.256,3))}')
