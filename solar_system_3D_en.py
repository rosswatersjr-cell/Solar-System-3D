...
def download_iers():
    try:
        if getattr(sys, 'frozen', False):# If File Is Executable
...
class Our_Solar_System(Entity):
    def __init__(self, **kwargs):
        ...
        self.spring_lbl = Text(parent=self.parent, text="-----Spring Equinox", x=0.78, y=0.40, scale=(1.2, 1.2), origin=(0.05, 0), color=color.green, text_size=1.0, eternal=True)
        self.summer_lbl = Text(parent=self.parent, text="-----Summer Solstice", x=0.78, y=0.37, scale=(1.2, 1.2), origin=(0, 0), color=color.red, text_size=1.0, eternal=True)
        self.autumn_lbl = Text(parent=self.parent, text="-----Autumn Equinox", x=0.78, y=0.34, scale=(1.2, 1.2), origin=(0, 0), color=color.yellow, text_size=1.0, eternal=True)
        self.winter_lbl = Text(parent=self.parent, text="-----Winter Solstice", x=0.78, y=0.31, scale=(1.2, 1.2), origin=(0.055, 0), color=color.hex("#1e90ff"), text_size=1.0, eternal=True)
        ...
        self.exit_button = Button(text='Quit', scale_x=0.08, scale_y=0.025, position=(0.84, 0.485), color=color.red, text_size=1.0, text_color=color.black, eternal=True)
        self.hide_data = Button(text='Hide Data', scale_x=0.12, scale_y=0.025, position=(0.73, 0.485), color=color.cyan, text_size=1.0, text_color=color.black, eternal=True)
        self.start_stop_button = Button(text='Start', scale_x=0.08, scale_y=0.025, position=(0.21, 0.485), color=color.cyan, text_size=1.0, text_color=color.black, eternal=True)
        self.grid = Button(text='Toggle Grid', scale_x=0.13, scale_y=0.025, position=(0.595, 0.485), color=color.cyan, text_size=1.0, text_color=color.black, eternal=True)
        self.repeat_button = Button(text='Repeat is On', scale_x=0.15, scale_y=0.025, position=(0.445, 0.485), color=color.cyan, text_size=1.0, text_color=color.black, eternal=True)
        self.units_menu=DropdownMenu('Select Units', buttons=[DropdownMenuButton(text='AU', on_click=Func(self.select_units, 'AU'),ignore_paused=True, eternal=True), 
                                        ...
                                        ignore_paused=True, scale=(0.10, 0.026), position=(0.26, 0.498), color=color.cyan, text_size=1.0, text_color=color.black, enabled = True, eternal=True)
        self.delay_lbl = Text(parent=self.parent, text="Delay in sec.", x=0.11, y=0.49, scale=(1.2, 1.2), origin=(0, 0), color=color.cyan, text_size=1.0, eternal=True)
        self.delay = InputField(parent=self.parent, x=0.11, y=0.47, scale=(0.1, 0.02), origin=(0, 0.1), color="#1c0a47", text_size=1.0, limit_content_to="0123456789.", eternal=True)
        self.increment_lbl = Text(parent=self.parent, text="Time Increment (hrs)", x=-0.043, y=0.49, scale=(1.2, 1.2), origin=(0, 0), color=color.cyan, text_size=1.0, eternal=True)
        self.increment = InputField(parent=self.parent, x=-0.043, y=0.47, scale=(0.15, 0.02), origin=(0, 0.1), color="#1c0a47", text_size=1.0, limit_content_to="0123456789.", eternal=True)
        self.increment_days_lbl = Text(parent=self.parent, text="Days =", x=-0.043, y=0.44, scale=(1.2, 1.2), origin=(0, 0), color=color.cyan, text_size=1.0, eternal=True)
        self.duration_lbl = Text(parent=self.parent, text="Time Duration (Days)", x=-0.234, y=0.49, scale=(1.2, 1.2), origin=(0, 0), color=color.cyan, text_size=1.0, eternal=True)
        self.duration_days = InputField(parent=self.parent, x=-0.234, y=0.47, scale=(0.15, 0.02), origin=(0, 0.1), color="#1c0a47", text_size=1.0, limit_content_to="0123456789.", eternal=True)
        self.duration_years = Text(parent=self.parent, text="Years =", x=-0.234, y=0.44, scale=(1.2, 1.2), origin=(0, 0), color=color.cyan, text_size=1.0, eternal=True)
        self.start_time_lbl = Text(parent=self.parent, text="Local Start Date / Time", x=-0.445, y=0.49, scale=(1.2, 1.2), origin=(0, 0), color=color.cyan, text_size=1.0, eternal=True)
        self.start_time = InputField(parent=self.parent, x=-0.450, y=0.47, scale=(0.22, 0.02), origin=(0, 0.1), color="#1c0a47", text_size=1.0, limit_content_to="0123456789T-:", eternal=True)
        self.zone_lbl = Text(parent=self.parent, text="Local Time Zone", x=-0.73, y=0.49, scale=(1.2, 1.2), origin=(0, 0), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.latitude_lbl = Text(parent=self.parent, text="Latitude:", x=-0.77, y=0.44, scale=(1.2, 1.2), origin=(0.5, 0), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.longitude_lbl = Text(parent=self.parent, text="Longitude:", x=-0.77, y=0.415, scale=(1.2, 1.2), origin=(0.5, 0), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.altitude_lbl = Text(parent=self.parent, text="Altitude (m):", x=-0.77, y=0.390, scale=(1.2, 1.2), origin=(0.5, 0), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.time_now = Text(parent=self.parent, text="Local Time Now:", x=-0.88, y=0.371, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.time_end = Text(parent=self.parent, text="Local Time End:", x=-0.88, y=0.348, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.sun_rise_set = Text(parent=self.parent, text="Local Sunrise / Sunset:", x=-0.88, y=0.325, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.moon_rise_set = Text(parent=self.parent, text="Local Moonrise / Moonset:", x=-0.88, y=0.302, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.moon_new_full = Text(parent=self.parent, text="Next New Moon / Full Moon:", x=-0.88, y=0.279, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.moon_brightness = Text(parent=self.parent, text="Moon Illumination:", x=-0.88, y=0.256, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.earth_moon = Text(parent=self.parent, text="Moon Distance To Earth:", x=-0.88, y=0.233, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mercury_earth = Text(parent=self.parent, text="Mercury Distance To Earth:", x=-0.88, y=0.21, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.venus_earth = Text(parent=self.parent, text="Venus Distance To Earth:", x=-0.88, y=0.187, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mars_earth = Text(parent=self.parent, text="Mars Distance To Earth:", x=-0.88, y=0.164, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.jupiter_earth = Text(parent=self.parent, text="Jupiter Distance To Earth:", x=-0.88, y=0.141, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.saturn_earth = Text(parent=self.parent, text="Saturn Distance To Earth:", x=-0.88, y=0.118, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.uranus_earth = Text(parent=self.parent, text="Uranus Distance To Earth:", x=-0.88, y=0.095, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.neptune_earth = Text(parent=self.parent, text="Neptune Distance To Earth:", x=-0.88, y=0.072, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mercury_sun = Text(parent=self.parent, text="Mercury Distance To Sun:", x=-0.88, y=0.049, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.venus_sun = Text(parent=self.parent, text="Venus Distance To Sun:", x=-0.88, y=0.026, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.earth_sun = Text(parent=self.parent, text="Earth Distance To Sun:", x=-0.88, y=0.003, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mars_sun = Text(parent=self.parent, text="Mars Distance To Sun:", x=-0.88, y=-0.02, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.jupiter_sun = Text(parent=self.parent, text="Jupiter Distance To Sun:", x=-0.88, y=-0.043, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.saturn_sun = Text(parent=self.parent, text="Saturn Distance To Sun:", x=-0.88, y=-0.066, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.uranus_sun = Text(parent=self.parent, text="Uranus Distance To Sun:", x=-0.88, y=-0.089, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.neptune_sun = Text(parent=self.parent, text="Neptune Distance To Sun:", x=-0.88, y=-0.112, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.moon_orbits = Text(parent=self.parent, text="Moon Orbits Sun / Orbits Earth:", x=-0.88, y=-0.135, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mercury_days = Text(parent=self.parent, text="Mercury Rotations / Orbits:", x=-0.88, y=-0.158, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.venus_days = Text(parent=self.parent, text="Venus Rotations / Orbits:", x=-0.88, y=-0.181, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.earth_days = Text(parent=self.parent, text="Earth Rotations / Orbits:", x=-0.88, y=-0.204, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mars_days = Text(parent=self.parent, text="Mars Rotations / Orbits:", x=-0.88, y=-0.227, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.jupiter_days = Text(parent=self.parent, text="Jupiter Rotations / Orbits:", x=-0.88, y=-0.250, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.saturn_days = Text(parent=self.parent, text="Saturn Rotations / Orbits:", x=-0.88, y=-0.273, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.uranus_days = Text(parent=self.parent, text="Uranus Rotations / Orbits:", x=-0.88, y=-0.296, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.mercury_nearest = Text(parent=self.parent, text="Mercury Nearest To Earth Date / Distance:", x=-0.88, y=-0.365, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.venus_nearest = Text(parent=self.parent, text="Venus Nearest To Earth Date / Distance::", x=-0.88, y=-0.388, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.mars_nearest = Text(parent=self.parent, text="Mars Nearest To Earth Date / Distance:", x=-0.88, y=-0.411, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.jupiter_nearest = Text(parent=self.parent, text="Jupiter Nearest To Earth Date / Distance:", x=-0.88, y=-0.434, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.saturn_nearest = Text(parent=self.parent, text="Saturn Nearest To Earth Date / Distance:", x=-0.88, y=-0.457, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        self.uranus_nearest = Text(parent=self.parent, text="Uranus Nearest To Earth Date / Distance:", x=-0.88, y=-0.480, scale=(1.2, 1.2), origin=(-.5, .5), color=color.cyan, text_size=1.0, eternal=True)
        ...
        self.increment_days_lbl.text=(f'Days = {str(round(float(self.increment.text) / 24, 5))}')
        self.Duration = (float(self.duration_days.text) / 365.256) 
        self.duration_years.text=(f'Years = {str(round(float(self.duration_days.text) / 365.256, 5))}')
    ...
    def setup_solar_system(self):
        ...
        planet_radius=[0.1915, 0.47, 5.5, 0.1364, 0.266, 5.486, 4.57, 1.99, 1.932]# Radius Referenced to Earth Using Ratios. 6378.1 km = 0.5
        self.planets = {
    ...
    def finalize_data(self):# Exaggerate Moons Orbit To Accomidate Size Of Earth. Add My Location On Earth Object
        ...
        for e in range(0, len(self.Local_Time)):
            try:
                ...
                moon[e]=[element * 70 for element in self.Planets_Data[3][e]] # Move Moon Outside Enlarged Earth * 80
...
if __name__ == '__main__':
    ...
    app=Ursina(title="Our Solar System", size=window_size, fullscreen=False, vsync=False, development_mode=False, icon='earth.ico')
    camera.fov = 50
    EditorCamera()
